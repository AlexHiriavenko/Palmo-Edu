...
echo "Сьогодні: " . $daysOfWeek[date('N')];
echo BR;
...
echo "День тижня №{$day} це {$targetDay}";
echo BR;
...
// Виведіть за допомогою цього масиву понеділок українською та середу англійською (понеділок - це перший день).
...
//  Нехай тепер у змінній $lang зберігається мова (значення або 'ua', або 'en'), а у змінній $day - номер дня. 
// Виведіть словом день тижня, що відповідає змінним $lang і $day. $lang = 'ru' і $day = 3 -> 'середа'.

$lang = 'ua';

$targetDay = $arr[$lang][$day] ?? "Не існуючий день тижня.";
echo "День тижня №{$day} на мові " . strtoupper($lang) . " це {$targetDay}";
echo BR;
